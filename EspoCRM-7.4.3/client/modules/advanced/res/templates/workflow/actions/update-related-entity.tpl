...
<div class="row">
    ...
    <div class="col-md-10">
        ...
        {{#if linkTranslated}} <span class="text-muted">&raquo;</span> {{{linkTranslated}}}{{/if}}
        {{#if parentEntityTypeTranslated}} <span class="text-muted">&raquo;</span> {{{parentEntityTypeTranslated}}}{{/if}}
