<div class="clearfix">
    <a href="javascript:" class="pull-right" data-action="removeGroup"><span class="fas fa-times"></span></a>
</div>
<div class="row form-group">
    ...
    <div class="col-md-12 operator-container field" data-name="operator">{{{operator}}}</div>
